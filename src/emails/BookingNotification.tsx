...
export default function BookingNotification({ name, email, day, dateLabel, time, date }: Props) {
	return (
		<Html>
			<Head />
			<Preview>Call booked — {name} · {day} {dateLabel} at {time}</Preview>
			<Body style={{ backgroundColor: colors.bg, margin: 0, padding: 0, fontFamily: fonts.sans }}>
				<Container style={{ maxWidth: 560, margin: "0 auto", padding: "48px 24px" }}>
					...
					<Heading style={{ color: colors.ink, fontSize: 24, fontWeight: 500, letterSpacing: "-0.02em", lineHeight: 1.3, margin: "0 0 24px" }}>
						{name} booked a call
					</Heading>
					...
					<Section style={{ backgroundColor: colors.surface, borderRadius: 12, padding: "28px 24px", border: `1px solid ${colors.line}` }}>
						<table style={{ width: "100%", borderCollapse: "collapse" as const }}>
							<tbody>
								<tr>
									<td style={{ padding: "8px 0", verticalAlign: "top", width: 80 }}>
								...
								<tr>
									<td style={{ padding: "8px 0", verticalAlign: "top" }}>
										<Text style={{ color: colors.muted, fontSize: 12, fontFamily: fonts.mono, margin: 0 }}>Date</Text>
									</td>
									<td style={{ padding: "8px 0" }}>
										<Text style={{ color: colors.ink, fontSize: 15, margin: 0 }}>{day} · {dateLabel} ({date})</Text>
									</td>
								</tr>
								<tr>
									<td style={{ padding: "8px 0", verticalAlign: "top" }}>
										<Text style={{ color: colors.muted, fontSize: 12, fontFamily: fonts.mono, margin: 0 }}>Time</Text>
									</td>
									<td style={{ padding: "8px 0" }}>
										<Text style={{ color: colors.accent, fontSize: 18, fontWeight: 500, margin: 0 }}>{time} IST</Text>
									</td>
								</tr>
							</tbody>
						</table>
